...
@Test
public void hiddenItems() throws IOException {collects.clickAllButtons();}

@Test
public void itemsOfPage() throws IOException {collects.pageItemClick();}

@Test
public void pageBottomTextPrint(){collects.collectBottomText();}
